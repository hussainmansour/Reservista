...
public class CancellationService {
    ...
    public ResponseDTO<CancellationResponseDTO> cancelReservation (CancellationRequestDTO cancellationRequestDTO) throws CancellationExceptionHandler {
        this.cancellationHandler.handleRequest(cancellationRequestDTO);
